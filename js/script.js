        ...
        div.innerHTML = `
             <a href="${global.search.type}-details.html?id=${result.id}">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <small class="text-muted">Release: ${global.search.type=== 'movie' ? result.result_date: result.first_air_date}</small>
                    </p>
                </div>
        `;
